...
Based on the Table~\ref{tab:evaluation_results_embedding}, we use the \textit{bge-small-en-v1.5} model for the subsequent evaluations and analyses due to its superior performance across accuracy metric.
...
We choose the Sliding Window method as it provides the surrounding context of the text and for the window size, we select 3 as it has the highest F1 score and accuracy.
