...
\begin{table}
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{l|cccccccccc||c}
            \multicolumn{12}{c}{\fbox{\textit{Retrieval Method}}, fdsjnfkdsn, jfiewdf ,fjneirufj} \\ \\
            \multicolumn{1}{c}{\textbf{Model}} & \multicolumn{1}{l}{\begin{sideways}award\end{sideways}} & \multicolumn{1}{l}{\begin{sideways}birth\end{sideways}} & \multicolumn{1}{l}{\begin{sideways}death\end{sideways}} & \multicolumn{1}{l}{\begin{sideways}foundationPlace\end{sideways}} & \multicolumn{1}{l}{\begin{sideways}leader\end{sideways}} & \multicolumn{1}{l}{\begin{sideways}nbateam\end{sideways}} & \multicolumn{1}{l}{\begin{sideways}publicationDate\end{sideways}} & \multicolumn{1}{l}{\begin{sideways}spouse\end{sideways}} & \begin{sideways}starring\end{sideways} & \begin{sideways}subsidiary\end{sideways} & \multicolumn{1}{l}{\begin{sideways}Total\end{sideways}}  \\
            \midrule
...
% TODO: BARCHART Model Accuracy by category for all categories

\begin{table}
    \noindent
    \resizebox{\textwidth}{!}{
        \begin{tabular}{lccc||cc}
            \multicolumn{6}{c}{\fbox{\textit{Retrieval Method}}, fdsjnfkdsn, jfiewdf ,fjneirufj} \\ \\
            \multicolumn{1}{c}{\textbf{Model}} & \multicolumn{1}{l}{Stability} & \multicolumn{1}{l}{Avg. Request Duration} & \multicolumn{1}{l}{Avg. tokens per request} & ACC & F1 \\
            \midrule
            Gemma2                             & \textbf{0.450}                & \textbf{0.212}                            & 0.255                                       & 0.222    & 0.222   \\
            Gemma2                             & \textbf{0.450}                & \textbf{0.212}                            & 0.255                                       & 0.222    & 0.222   \\
            Gemma2                             & \textbf{0.450}                & \textbf{0.212}                            & 0.255                                       & 0.222    & 0.222   \\
            Gemma2                             & \textbf{0.450}                & \textbf{0.212}                            & 0.255                                       & 0.222    & 0.222   \\ \hline
            Proposed                           & \textbf{0.450}                & \textbf{0.212}                            & 0.255                                       & 0.222    & 0.222   \\
            \bottomrule
        \end{tabular}}
    \caption{Evaluation Results for Different Methods through the Pipeline (just with the Gemma2 model)}
...
% TODO: RADARCHART TO HAVE BETTER INSIGHTS WITH CATEGORIES, MOSTLY STABILITY CAN SHOWN HERE
