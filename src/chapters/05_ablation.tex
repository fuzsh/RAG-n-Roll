...
\begin{table}[h!]
    \centering
    \noindent
    {\scriptsize \fbox{\textit{Retrieval Method}}, BAAI/bge-small-en-v1.5, Sliding Window (ws 6) , Similarity Cut-off (Re-rank), Top\_k 3}
    \resizebox{0.7\textwidth}{!}{
        \begin{tabular}{lccc}
            \toprule
            \textbf{Method} & Acc & F1 & Latency \\
            \midrule
            \textit{Unsupervised}               & & & \\
            Bm25                                & 0.8882          & 0.8940          & N/A \\
            contriever-msmarco                  & 0.8932          & 0.8988          & N/A \\
            \hline
            \textit{supervised}                 & & & \\
            jina-reranker-v2-base-multilingual  & 0.9004          & 0.9065          & N/A \\
            ms-marco-MiniLM-L-6-v2              & \textbf{0.9014} & \textbf{0.9077} & N/A \\
            \bottomrule
        \end{tabular}}
...
\begin{table}[h!]
    \centering
    \noindent
    {\scriptsize ms-marco-MiniLM-L-6-v2,\fbox{\textit{Embedding Model}}, Sliding Window (ws 6) , Similarity Cut-off (Re-rank), Top\_k 3}
    \resizebox{0.7\textwidth}{!}{
        ...
        \begin{tabular}{lccc}
            ...
            \midrule
            stella\_en\_1.5B\_v5                  & 0.8961          & 0.9028          & N/A \\
            jina-embeddings-v3\tnote{*}           & 0.8852          & 0.9097          & N/A \\
            gte-large-en-v1.5\tnote{*}            & 0.8971          & \textbf{0.9174} & N/A \\
            multilingual-e5-large-instruct        & 0.8954          & 0.9018          & N/A \\
            bge-small-en-v1.5                     & \textbf{0.9014} & 0.9077          & N/A \\
            \bottomrule
        \end{tabular}
        \begin{tablenotes}
...
\begin{table}[h!]
    \centering
    \noindent
    {\scriptsize ms-marco-MiniLM-L-6-v2, BAAI/bge-small-en-v1.5,\fbox{\textit{Chunking Strategy}}, Similarity Cut-off (Re-rank), Top\_k 3}
    \resizebox{0.75\textwidth}{!}{
        \begin{tabular}{llccc}
            \toprule
            \textbf{Method} & \textbf{Parameters} & Acc & F1 & Latency \\
            \midrule
            \multirow{3}{*}{Original}           & Chuck Size: 256       & 0.8914          & 0.8914          & N/A \\
                                                & Chuck Size: 512       & 0.8932          & 0.8993          & N/A \\
                                                & Chuck Size: 1024      & 0.8946          & 0.8993          & N/A \\ \hline
            small2big                           & Chuck Size: 1024      & 0.8889          & 0.8953          & N/A \\ \hline
            \multirow{2}{*}{Sliding Window}     & Window Size: 6        & \textbf{0.9014} & 0.9077          & N/A \\
                                                & Window Size: 3        & \textbf{0.9014} & \textbf{0.9080} & N/A \\
            \bottomrule
        \end{tabular}}
...
\begin{table}[h!]
    \centering
    \noindent
    {\scriptsize ms-marco-MiniLM-L-6-v2, BAAI/bge-small-en-v1.5, Sliding Window (ws 3), \fbox{\textit{Similarity Cut-off}}, Top\_k 3}
    \resizebox{0.7\textwidth}{!}{
        \begin{tabular}{lccc}
            \toprule
            \textbf{Method} & Acc & F1 & Latency \\
            ...
            similarity cut-off (original score)                     & \textbf{0.9018} & \textbf{0.9080}         & N/A \\
            similarity cut-off (re-ranked score)                    & 0.9014          & \textbf{0.9080}         & N/A \\
            \bottomrule
        \end{tabular}}
...
\begin{table}[h!]
    ...
    \resizebox{0.5\textwidth}{!}{
        \begin{tabular}{lccc}
            ...
            \textbf{Method} & Acc & F1 & Latency \\
            \midrule
            Top\_k 3                     & 0.9018               & 0.9080                    & N/A \\
            Top\_k 6                     & \textbf{0.9032}      & \textbf{0.9101}           & N/A \\
            \bottomrule
        \end{tabular}}
...
\begin{table}
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{lccc||cc}
            ...
            \midrule
            Gemma2                             & 0.8720                         & N/A                            & N/A                                       & \textbf{0.9032}    & \textbf{0.9101}   \\
            Qwen2.5                            & 0.8685                         & N/A                            & N/A                                       & 0.8729    & 0.8888   \\
            LLama3.1                           & 0.8291                         & N/A                            & N/A                                       & 0.8154    & 0.8299   \\
            Mistral                            & 0.8650                         & N/A                            & N/A                                       & 0.8511    & 0.8733   \\ \hline
            Proposed (At\_Most)                & \textbf{0.9176}                & N/A                            & N/A                                       & 0.8964    & 0.9071   \\
            \bottomrule
        \end{tabular}}
    \caption{Evaluation Results for Whole Pipeline}
