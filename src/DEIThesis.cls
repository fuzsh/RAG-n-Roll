...
\RequirePackage{pifont}  % For checkmark and cross symbols}
...
% graduation date
\def\gradutionDate#1{\gdef\@gradutionDate{#1}}
...
\renewcommand{\maketitle} {
  ...
  % set academic year and date in footer
  \cfoot{\normalsize\textsc{Academic Year \\ \@academicYear \\ \vspace{2ex} Date: \@gradutionDate}}
